...
const ProviderLanding = () => {
  const features = [
    {
      icon: Store,
      title: 'متجرك الخاص',
      description: 'أنشئ متجرك الإلكتروني بسهولة مع تصميم مخصص يعكس هويتك'
    },
    {
      icon: MapPin,
      title: 'خدمة الحي',
    ...
    {
      icon: Truck,
      title: 'نظام توصيل متكامل',
      description: 'تتبع مباشر للطلبات مع حسابات دقيقة للمسافة والوقت'
    },
    {
      icon: BarChart3,
      title: 'تقارير وإحصائيات',
      description: 'تابع مبيعاتك وأداءك بتقارير تفصيلية ورسوم بيانية'
    },
    {
      icon: CreditCard,
      title: 'دفع إلكتروني',
      description: 'استقبل المدفوعات إلكترونياً أو نقداً عند الاستلام'
    },
    {
      icon: Bell,
      title: 'إشعارات فورية',
      description: 'تنبيهات صوتية ومرئية لكل طلب جديد'
    },
    {
      icon: Palette,
      title: 'تخصيص المتجر',
      description: 'غيّر الألوان والخطوط والتصميم ليناسب هويتك'
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Shield,
      title: 'دفع آمن',
      description: 'حماية كاملة للمعاملات المالية عبر بوابات دفع موثوقة'
    }
  ];
  ...
  const howItWorks = [
    ...
    },
    {
      step: 2,
      title: 'أضف منتجاتك',
      description: 'أضف منتجاتك مع الصور والأسعار والخيارات',
      icon: Store
    },
    {
      step: 3,
      title: 'استقبل الطلبات',
      description: 'تابع طلباتك من لوحة تحكم سهلة الاستخدام',
      icon: Bell
    },
    {
      step: 4,
  ...
  const stats = [
    ...
    { value: '+10,000', label: 'طلب شهرياً' },
    { value: '+50', label: 'حي مغطى' },
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                ابدأ مشروعك مع
                <span className="text-primary"> منصة الحي </span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                أنشئ متجرك الإلكتروني وقدّم خدماتك لسكان حيّك بسهولة.
            ...
            >
              {stats.map((stat, index) => (
                <motion.div
                  key={stat.label}
                  className="bg-card/80 backdrop-blur rounded-xl p-4 text-center border"
        ...
        <section id="features" className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-4">كل ما تحتاجه لإدارة مشروعك</h2>
              <p className="text-muted-foreground text-lg">أدوات قوية لنجاح مشروعك المحلي</p>
            </motion.div>
        ...
        <section className="py-20 bg-gradient-to-br from-primary/5 to-accent/5">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-4">خطط اشتراك مرنة</h2>
              <p className="text-muted-foreground text-lg">اختر الخطة المناسبة لمشروعك</p>
            </motion.div>
            <motion.div 
            ...
            >
              <Card className="border-primary/20 bg-gradient-to-br from-card to-primary/5">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold mb-2">ابدأ مجاناً</h3>
                  <p className="text-muted-foreground mb-6">
                    جرّب المنصة كاملة لمدة أسبوع بدون أي التزام
                  </p>
                  <Button size="lg" className="w-full text-lg font-arabic" asChild>
                    <Link to="/provider-register">
                      سجّل الآن
                      <ArrowLeft className="h-5 w-5 mr-2" />
                    </Link>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-4">ماذا يقول مقدمو الخدمات؟</h2>
              <p className="text-muted-foreground text-lg">تجارب حقيقية من أصحاب المشاريع</p>
            </motion.div>
